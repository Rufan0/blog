...
> CTF-in qısa izahı [Link](https://github.com/Rufan0/CTF/blob/main/Thoth%20Tech%201/README.md)
...
.ova faylının üzərinə klik edirik və Virtualbox açılacaq **İMPORT** və ən son olaraq **NETWORK** ayarını edirik.

> Mən ctf-i Kali Linux üzərindən edəcəm deyə həm *Kali Linux-u* həm də *Thoth Tech* i eyni networka qoşuram.
...
User flag əldə etdik root folderinə daxil olmaq istədim ancaq alınmadı, indi isə *Privilege Escalation* edib root olmalıyıq ki, root flagini əldə edək.
