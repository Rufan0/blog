...
> Yaddan çıxarmayın ki saytda hər bir məlumat bizim üçün ipucudur. Mən bir notpad ilə nmap portscan və ya digər məlumatları həmçinin saytda qarşıma çıxan məlumatları qeyd aparacam.

![Wakanda4](https://i.imgur.com/iq3VXBQ.png)

- Saytın aşağı hissəsində `mamadou` yazılıb nu hər hansısa bir istifadəçi adı ola bilər bunu qıraqda qeyd edək.
...
- İlk olaraq linki bu halda daxil edəndə dəyişiklik olmur daha sonra işə
...
- Decode edəndən sonra belə bir mətn əldə deirik. Bir password əldə etdik.
...
> normalda SSH 21 portunda işləyir amma nmap ilə acan edəndə gördük ki bu vm-da SSH 3333 portunda işləyir. 

- SSH portuna bağlanmağa çalışaq.

![Wakanda9](https://i.imgur.com/b0DXoHM.png)

- Bağlantı alındaı və bizi python pəncərəsi qarşıladı, ls  ls-la əmrlərini icra etdikdə xəta yazısı qlırıq.
